...
// alpha channel.
func DrawImage(buff draw.Image, img image.Image, x, y int) { _ = "STUB: not implemented"; return }
...
func OverwriteImage(buff draw.Image, img image.Image, x, y int) { _ = "STUB: not implemented"; return }
