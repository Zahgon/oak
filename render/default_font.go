...
func NewStringerText(str fmt.Stringer, x, y float64) *Text { _ = "STUB: not implemented"; return nil }
...
func NewIntText(str *int, x, y float64) *Text { _ = "STUB: not implemented"; return nil }

// NewText is a helper to create a text element with the default font and a string.
func NewText(str string, x, y float64) *Text { _ = "STUB: not implemented"; return nil }

// NewStrPtrText is a helper to take in a string pointer for NewText
func NewStrPtrText(str *string, x, y float64) *Text { _ = "STUB: not implemented"; return nil }
